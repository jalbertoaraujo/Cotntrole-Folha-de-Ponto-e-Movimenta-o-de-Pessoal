...
public class ListarContratosRelDAO {

	private Connection connection;

	public ListarContratosRelDAO() {
	...
	public void listar() {
		...
		DefaultTableModel tab = (DefaultTableModel) TelaExibirContratos.tabelaexibircontrato.getModel();
		
		String sql = "select distinct contrato from colaborador where periodo = '"+ Relatorios.cbperiodorel.getSelectedItem() +"'order by contrato asc";
