...
public class RelatorioGeralPorContratoDao {
	
	private Connection connection;
	

	public RelatorioGeralPorContratoDao(){
	...
	public void RelatorioGeralDao(){
		...
		String sql = " Select * from colaborador where periodo = '"+ Relatorios.cbperiodorel.getSelectedItem().toString() +"' and contrato like '%"+ Relatorios.tfgeraldepartamentorel.getText() +"%' and tipo = '"+ Relatorios.cbgeraltiporel.getSelectedItem() +"' and verificado = '"+ Relatorios.cbgeralstatusrel.getSelectedItem() +"'";
		...
		try {
			...
			JasperPrint jp = JasperFillManager.fillReport("RelIreport/PontoEpiGeralPorContrato.jasper", new HashMap(), jrrs);
