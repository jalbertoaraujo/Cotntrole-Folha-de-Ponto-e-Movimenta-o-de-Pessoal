...
public class RelatorioStatusDao {
	...
	public void RelatorioStatusdao(){
		...
		try {
			...
			JasperPrint jp = JasperFillManager.fillReport("RelIreport/PontoEpiContrato.jasper", new HashMap(), jrrs);
