...
public class TelaAdmissaoAlterar extends JFrame {
			...
			public void run() {
				try {
					UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");// Visual
																									// do
																									// Windows
					TelaAdmissaoAlterar frame = new TelaAdmissaoAlterar();
	 ...
	 * Create the frame.
	 */
	public TelaAdmissaoAlterar() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(TelaAdmissaoAlterar.class.getResource("/Imagem/sdalogo.png")));
		setTitle("ADMISS\u00C3O");
		setResizable(false);
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 890, 646);
		...
		btnalterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cbsituacaoadmissaoalt.getSelectedItem().equals("---")) {
					...
					AlterarDepartamentoAdmissaoDao adad= new AlterarDepartamentoAdmissaoDao();
		...
		btnalterar.setBounds(687, 582, 187, 23);
		...
		cbcontratacaoalt.setEnabled(false);
		...
		tfhorarioalt.setEditable(false);
		...
		tfadsalarioalt.setEditable(false);
		...
		tfoutrosbeneficiosalt.setEditable(false);
		...
		cbobrigatorioalt.setEnabled(false);
		...
		tfsalarioalt.setEditable(false);
		...
		tfescolaridadealt.setEditable(false);
		...
		tfdatainicioalt.setEditable(false);
		...
		tfdataautoalt.setEditable(false);
		...
		tfresponsavelalt.setEditable(false);
		...
		tfindicacaoalt.setEditable(false);
		...
		JButton btnNewButton_1 = new JButton("IMPRIMIR MP");
		...
		btnNewButton_1.setBounds(550, 582, 132, 23);
