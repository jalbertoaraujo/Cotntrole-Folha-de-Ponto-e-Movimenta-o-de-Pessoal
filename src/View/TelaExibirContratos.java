...
public class TelaExibirContratos extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					TelaExibirContratos frame = new TelaExibirContratos();
	 ...
	 * Create the frame.
	 */
	public TelaExibirContratos() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaExibirContratos.class.getResource("/Imagem/sdalogo.png")));
		setTitle("Contratos");
		...
		tabelaexibircontrato.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(arg0.getClickCount() == 2){
					...
					int[] indicelinha = TelaExibirContratos.tabelaexibircontrato.getSelectedRows();
...
//					JOptionPane.showMessageDialog(null, lista1);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				RelatorioGeralFaltantesPorPeriodoeContratoDao rgfppc = new RelatorioGeralFaltantesPorPeriodoeContratoDao();
