...
public class HistoricoFolha extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					HistoricoFolha frame = new HistoricoFolha();
	...
	public HistoricoFolha() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(HistoricoFolha.class.getResource("/Imagem/sdalogo.png")));
		setTitle(" INFORMA\u00C7\u00C3O");
